  ...
  return (
    <div className="frame">
      <div className="frame-layers">
        {stages.map((s, i) => {
          const opacity = clamp(1 - Math.abs(pos - i), 0, 1);
          ...
          return (
            <div
              ...
              style={{
                ...
                zIndex: i,
                transition: dragging ? "none" : `opacity ${morphMs}ms cubic-bezier(.4,0,.2,1)`,
              }}
            >
              {window.ROOM_IMAGES && window.ROOM_IMAGES[s.key]
                ? <img src={window.ROOM_IMAGES[s.key]} alt={s.name} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
                : <image-slot
