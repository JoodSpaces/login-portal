...
window.ROOM_STAGES = [
  ...
  },
  {
    ...
    state: "after",
    blurb:
      "Photographed, listed, and earning. The finished unit goes live on Airbnb, Booking.com and the JOOD direct channel against a dynamic rate calendar.",
    items: [
      { name: "Rate uplift", spec: "+147% vs long-term let" },
      { name: "Setup window", spec: "14 days · Model 01" },
      { name: "Landlord upfront", spec: "0 EGP · JOOD-financed" },
      { name: "Post-stage rating", spec: "4.8★ average" },
    ],
  },
];
